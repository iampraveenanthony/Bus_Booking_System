print("____________________ BUS BOOKING SYSTEM____________________")

# Global variable to store user details
user_details = {}

#_________User Registration_________
...
#_________Booking Tickets___________

class Booking(BusDetails):
    def booked(self):
        print(" ")
        print("--------------------< Booking Your Tickets >--------------------")
...
#_________See Again Avalable Bus___________
...
class bill():
        def pay(self):
            print(" ")
            payment = input("Confirm Your Ticket ---->  Yes / No :")
